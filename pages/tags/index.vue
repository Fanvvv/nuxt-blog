<style scoped>
.tags-item {
  @apply h-4 px-4 py-2 mx-5 my-5 border-2 rounded-2xl shadow-lg shadow-gray-900 dark:shadow-gray-300;
}
</style>
<template>
  <div font-mono dark:text-gray-300 >
    ...
    <div mt-10>
      <span v-for="item in sortedTags" v-motion-pop class="tags-item">
